...
A f=g->getFrameCount();
I(!f) {
F(A b:g->getStartLocations())ep.insert(b);
...
C 41:I(x && u->canAttack() && u D(x) < 33) {u->attack(x);B;}
I(bo == 4 && !us&&f > 2000) {
us = u;
...
E I(cb(43)) u M(43);
E u M(37);B;
C 42:I(!fo)fo=u;I(u J){I(ep.size() > 1) {
A vv = set(ep.begin(), ep.end());
I(fo!=u)vv.Q(gt(fo));
TP r;A d=st;
F(A p:vv)I(u D(P{ p }) < d) { d = u D(P{ p }); r = p; }
...
I(pb){
TP bl;A d=st;A xx=pb GT.x;A yy=pb GT.y;
...
I(u T.RD&&ep.find(u GT)!=ep.end())F(A t:ep)I(t!=u GT)ep.Q(t);}}};